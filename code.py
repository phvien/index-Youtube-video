...
"""
***** Author: phvien (https://github.com/phvien)
**** License: CC-BY
*** OS platform: Ubuntu 18.04.2 LTS
** VIM - Vi IMproved 8.0 editor
* The program only works on python versions 3.0, 3.1 or 3.++ 
...
***** Author: phvien, dhau (https://github.com/phvien)
**** License: CC-BY
*** OS platform: Ubuntu 18.04.2 LTS
** Vi IMproved 8.0 editor
* Python versions 3.++
	""")
	main()
